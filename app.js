...
const databasePath=path.join(dirname__,"cricketTeam.db");
const app = express();
...
app.put("/players/:playerId/",async (request, response)=>{
  ...
  const updatePlayersQuery = `
    ...
    `;
  const player= await database.run(updatePlayersQuery);
...
app.delete("/players/:playerId/",async(request, response)=>{
    ...
    `;
    const player= await database.run(deletePlayersQuery);
